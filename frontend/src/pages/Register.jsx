    ...
    <div className="w-screen h-screen flex flex-col xl:flex-row bg-[#221818] p-5 md:p-10 xl:p-15">
        ...
        <div className="w-full h-full border-[#a70d1c] border-4 rounded-b-2xl flex flex-col items-center justify-center
           ...
           <form className="w-full max-w-sm font-varuna p-5 ">
                ...
                <div className="md:flex md:items-center mb-6">
                    <div className="md:w-1/3">
                    <label className="block text-gray-500 md:text-right mb-1 md:mb-0 pr-4" forname="inline-email">
                        EMAIL
                    </label>
                    </div>
                    <div className="md:w-2/3">
                    <input className="bg-gray-200 appearance-none border-4 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#a70d1c]" id="inline-email" type="text" placeholder="jane.doe@email.com"/>
                    </div>
                </div>
                ...
                <div className="md:flex md:items-center mb-6">
                    <div className="md:w-1/3">
                    <label className="block text-gray-500 md:text-right mb-1 md:mb-0 pr-4" forname="inline-confirm-password">
                        CONFIRM PASSWORD
                    </label>
                    </div>
                    <div className="md:w-2/3">
                    <input className="bg-gray-200 appearance-none border-4 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-[#a70d1c]" id="inline-confirm-password" type="password" placeholder="******************"/>
                    </div>
                </div>
                ...
                <div className="md:flex md:items-center">
                    <div className="md:w-1/3"></div>
                    <div className="md:w-2/3">
                    <Buttons.Base>REGISTER</Buttons.Base>
                    </div>
                </div>
                </form>
